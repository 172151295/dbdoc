...
// trend 为可选：有值时显示趋势标签，无值时仅显示描述
const hasTrend = computed(() => props.trend !== undefined);
  ...
  >
    ...
    <div class="relative flex items-start justify-between">
      <div class="min-w-0 flex-1">
        ...
        <div v-if="hasTrend" class="mt-3 flex items-center gap-2 text-xs">
          <span
        ...
        <div v-else class="mt-3 flex items-center gap-2 text-xs">
          <span class="text-muted-foreground">{{ desc }}</span>
        </div>
      </div>
