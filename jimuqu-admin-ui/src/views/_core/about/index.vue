...
const description = '基于 Screw 引擎构建的数据库文档自动生成与对象导出平台。';
const name = 'DBDoc Admin';
const title = '关于';
...
const baseInfoItems = computed<AboutDescriptionItem>(() => [
  ...
  {
    content: renderLink('https://github.com/0512ls/screw-web', '点击查看'),
    label: '代码仓库',
  },
  {
  ...
  <Page :title="title" content-class="flex flex-col gap-4">
    <template #description>
      <p class="text-foreground mt-3 text-sm/6">
        <a
          href="https://github.com/0512ls/screw-web"
          class="vben-link"
          target="_blank"
        >
          {{ name }}
