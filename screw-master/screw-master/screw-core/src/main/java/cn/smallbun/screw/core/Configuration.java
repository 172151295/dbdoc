...
public class Configuration implements Serializable {
    ...
    /**
     * 是否包含视图（VIEW），默认 false 仅导出表，true 时同时导出视图
     */
    private boolean          includeView;
    /**
     * 生成进度监听器（可选），逐表/视图上报进度
     */
     ...
     * @param progressListener {@link ProgressListener} 进度监听器（可选）
     */
    private Configuration(String organization, String organizationUrl, String title, String version,
                          ...
                          EngineConfig engineConfig, boolean includeView,
    ...
    public static class ConfigurationBuilder {
        ...
        public Configuration.ConfigurationBuilder includeView(boolean includeView) {
            this.includeView = includeView;
            return this;
        }

        public Configuration.ConfigurationBuilder progressListener(ProgressListener progressListener) {
            this.progressListener = progressListener;
            return this;
        }
        ...
        public Configuration build() {
            return new Configuration(this.organization, this.organizationUrl, this.title,
                ...
                this.engineConfig, this.includeView, this.progressListener);
        }
    }
}
