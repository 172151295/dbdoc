...
public enum EngineFileType implements Serializable {
                                                    ...
                                                    /**
                                                     * EXCEL (基于 EasyExcel 动态生成)
                                                     */
                                                    EXCEL(".xlsx", "documentation_excel",
                                                          "Excel文件"),
                                                    /**
                                                     * JSON
                                                     */
                                                     ...
                                                     * XML
                                                     */
                                                    XML(".xml", "documentation_xml", "XML文件"),
                                                    /**
                                                     * PDF（基于 freemarker HTML 模板 → openhtmltopdf 转换）
                                                     */
                                                    PDF(".pdf", "documentation_html", "PDF文件"),
                                                    /**
                                                     * DDL（SQL 建表/索引/注释语句，由 screw-web DdlService 生成）
                                                     */
                                                    DDL(".sql", "documentation_ddl", "DDL文件");
