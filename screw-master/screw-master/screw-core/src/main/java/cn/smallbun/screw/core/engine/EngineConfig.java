...
public class EngineConfig implements Serializable {
    ...
    /**
     * Excel 导出 Sheet 组织模式（仅 EXCEL 生效，默认 PER_TABLE）
     */
    private ExcelSheetMode             excelSheetMode;
    /**
     * 文档写入（produce）阶段逐表进度回调，可选；仅模板引擎支持时生效
     */
    private transient ProgressListener produceProgressListener;
}
