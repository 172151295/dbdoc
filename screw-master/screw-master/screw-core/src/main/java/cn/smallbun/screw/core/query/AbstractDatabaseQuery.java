...
public abstract class AbstractDatabaseQuery implements DatabaseQuery {
    ...
    public AbstractDatabaseQuery(DataSource dataSource, boolean includeView) {
    ...
    /**
     * 获取表类型集合
     * 默认仅查询 TABLE，includeView=true 时同时查询 VIEW
     *
     * @return {@link String[]} 表类型数组
     */
    protected String[] getTableTypes() {
        return includeView ? new String[] { "TABLE", "VIEW" } : new String[] { "TABLE" };
    }
