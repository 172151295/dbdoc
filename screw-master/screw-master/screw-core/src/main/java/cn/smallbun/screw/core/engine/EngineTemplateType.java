...
import cn.smallbun.screw.core.engine.excel.ExcelTemplateEngine;
import cn.smallbun.screw.core.engine.freemark.FreemarkerTemplateEngine;
import cn.smallbun.screw.core.engine.pdf.PdfTemplateEngine;
...
public enum EngineTemplateType implements Serializable {
                                                        ...
                                                        excel("/template/excel/",
                                                              ExcelTemplateEngine.class, ".xlsx"),
                                                        /**
                                                         * PDF 模板（Freemarker HTML → openhtmltopdf）
                                                         */
                                                        pdf("/template/freemarker/",
                                                            PdfTemplateEngine.class, ".ftl");
